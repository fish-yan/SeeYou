    ...
    switch (_status) {
        case LXChatBoxStatusNothing:
        {
            ...
            [UIView animateWithDuration:0.3 animations:^{
                self.frame = CGRectMake(0, SCREEN_HEIGHT - self.textView.height - 2 *BOXTEXTViewSPACE, SCREEN_WIDTH, self.textView.height + 2 *BOXTEXTViewSPACE);
...
{
    self.frame = CGRectMake(0, SCREEN_HEIGHT -HEIGHT_TABBAR, SCREEN_WIDTH, HEIGHT_TABBAR);
    self.talkButton.frame = CGRectMake(CHATBOX_BUTTON_WIDTH+ BOXBTNSPACE, (HEIGHT_TABBAR - HEIGHT_TEXTVIEW)/2, SCREEN_WIDTH -3 * CHATBOX_BUTTON_WIDTH - 2 *BOXBTNSPACE, HEIGHT_TEXTVIEW);
    self.voiceButton.frame = CGRectMake(0, (HEIGHT_TABBAR - CHATBOX_BUTTON_WIDTH)/2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH);
    self.faceButton.frame =CGRectMake(SCREEN_WIDTH -2 *CHATBOX_BUTTON_WIDTH, (HEIGHT_TABBAR - CHATBOX_BUTTON_WIDTH)/2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH);
    self.moreButton.frame =CGRectMake(SCREEN_WIDTH - CHATBOX_BUTTON_WIDTH, (HEIGHT_TABBAR - CHATBOX_BUTTON_WIDTH)/2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH);
}
#pragma mark--添加通知---
...
-(LXChatBoxFaceView *)faceView{
    if (!_faceView ) {
        _faceView =[[LXChatBoxFaceView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, BOXOTHERH)];
...
-(LXChatBoxMoreView *)moreView{
    if (!_moreView ) {
        _moreView =[[LXChatBoxMoreView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, BOXOTHERH)];
...
-(UIButton *)faceButton{
    if (!_faceButton) {
        _faceButton =[[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH -2 *CHATBOX_BUTTON_WIDTH, (HEIGHT_TABBAR - CHATBOX_BUTTON_WIDTH)/2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
...
-(UITextView *)textView{
    if (!_textView) {
        _textView =[[UITextView alloc]initWithFrame:CGRectMake(CHATBOX_BUTTON_WIDTH+ BOXBTNSPACE, (HEIGHT_TABBAR - HEIGHT_TEXTVIEW)/2, SCREEN_WIDTH -3 * CHATBOX_BUTTON_WIDTH - 2 *BOXBTNSPACE, HEIGHT_TEXTVIEW)];
